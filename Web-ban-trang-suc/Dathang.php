            ...
            {   
                ...
                {  
                    ...
                    foreach ($products as $productId => $productQuantity)
                    {
                        ...
                        $newQuantity = $row['SoLuongSP'] - $productQuantity;
                        $updateSoLuongSP = "UPDATE sanpham SET SoLuongSP = $newQuantity WHERE MaSP = $productId";
                        mysqli_query($con, $updateSoLuongSP);
                                ...
                                <table>
                                    <thead>
                                        <tr style="border-bottom: 3px solid #ececec;">
                                            <th class="tb_left">Sản phẩm x Số lượng</th>
                                    ...
                                    ?>
                                        <tr>
                                            <th class="tb_left" style="font-size: 17px;">Tổng tiền hàng</th>
                                        ...
                                        <tr style="border-bottom: 3px solid #ececec;" >
                                            <th class="tb_left" style="font-size: 17px; padding-bottom: 15px;">Tổng thanh toán</th>
