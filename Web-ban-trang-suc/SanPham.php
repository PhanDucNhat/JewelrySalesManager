...
<head>
    ...
    <link rel="stylesheet" href="SanPham.css?<?=time()?>" type="text/css">
...
<body>
                        ...
                        <div class="d-flex text-start text-capitalize">
                            ...
                            <?php 
                                ...
                                if(mysqli_num_rows($resultChatLieu)>0)
                                {
                                    ...
                                    { 
                                ?>
                                <a href="SanPham.php?BM=<?= $row['ChatLieu'];?>" class="text-decoration-none text-black text-start "><?= $row['ChatLieu']; ?></a>
                                <?php
                                    }
                                }
                            ?>
        ...
        <div class="d_main">
            <div class="d_row">
                <div class="d_col d_large-3">
                    ...
                    <span class="d_title-list text-uppercase fs-6" style="font-weight: 500;">Chất liệu</span>
                    <div class="d_divider-small"></div>
                    <div class="d_margin-bottom-20">
                    <ul class="list-group list-group-flush d_padding-15" style="height: 100% !important;">
                        <?php 
                        ...
                        if(mysqli_num_rows($resultChatLieu)>0)
                        {
                            ...
                            { 
                        ?>
                        <li class="list-group-item"><a href="SanPham.php?BM=<?= $row['ChatLieu'];?>" class="text-decoration-none text-black"><?= $row['ChatLieu']; ?></a></li>
                        <?php
                            }
                        }
                        ?>
                    ...
                    <div class="d_margin-bottom-20">            
                    <ul class="list-group list-group-flush d_padding-15">
                        <li class="list-group-item"><a href="SanPham.php?Min=1&Max=200000" class="text-decoration-none text-black">0 <sup>₫</sup> - 200.000 <sup>₫</sup></a></li>
                        <li class="list-group-item"><a href="SanPham.php?Min=200000&Max=300000" class="text-decoration-none text-black">200.000 <sup>₫</sup> - 300.000 <sup>₫</sup></a></li>
                        <li class="list-group-item"><a href="SanPham.php?Min=300000&Max=400000" class="text-decoration-none text-black">300.000 <sup>₫</sup> - 400.000 <sup>₫</sup></a></li>
                    </ul>
                    </div>
                </div>
                <div class="d_col d_large-9">
                    ...
                    <?php
                        // phan trang
                        $itemPerPage = !empty($_GET['per_page'])?$_GET['per_page']:9;
    ...
    <li class="nav-item"><a href="index.php" class="nav-link px-2 text-black">Trang chủ</a></li>
    <li class="nav-item"><a href="SanPham.php" class="nav-link px-2 text-black">Sản phẩm</a></li>
    <li class="nav-item"><a href="#" class="nav-link px-2 text-black">Tin tức</a></li>
    <li class="nav-item"><a href="phanhoi.php" class="nav-link px-2 text-black">Liên hệ</a></li>
</ul>

          <div class="container d_footer-flex">
            <p class="d_footer-text text-muted">&copy; Đại học Vinh</p>
