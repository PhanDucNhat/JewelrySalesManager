                ...
                <div >
                    <div class="input-group">
                        <div class="form-outline">
                            <input id="Search" type="text" onkeyup="searchTable()" class="form-control" placeholder="Nhập tên trang sức" required style="width: 350px"/>
                        </div> 
                ...
                <table class="table" id="myTable">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th scope="col" onclick="sortTable(1)" class="sort">Tên trang sức</th>
                            <th scope="col">Ảnh</th>
                            <th scope="col" onclick="sortTable(3)" class="sort">Thương Hiệu</th>
                            <th scope="col" onclick="sortTableNumber(4)" class="sort">Số lượng</th>
                            <th scope="col" onclick="sortTableNumber(5)" class="sort">Giá</th>
                            ...
                            while($row=mysqli_fetch_array($result_set))
                            {
                                ?>
                                    <tr class= "table__row text-center">
                                        <td  scope="row" style="width:30px !important; padding: 10px 0 !important;"><?php echo $row['MaSP'] ?></td>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document" style="max-width: 60% !important">
                        ...
                        <div class="modal-header text-center" style="background-color: var(--color-third);">
                            <h5 class="modal-title " id="exampleModalLabel">Chi tiết trang sức</h5>
                        </div>
