        ...
        while ($row = mysqli_fetch_array($result_set)) {
            ...
            <div class="main__right">
                ...
                <div class="main__product-cart">
                    <div class="cart__number">
                        <div class="buttons_added">
                            <form id="addToCartForm" method="post" action="giohang.php?ID=<?php echo $row['MaSP']; ?>">
                                <div>
                                <input class="minus is-form" type="button" value="-">
                                <input aria-label="quantity" class="input-qty" max="<?php echo $row['SoLuongSP']; ?>" min="1" name="txtProductQuantity" type="number" value="1">
                                <input class="plus is-form" type="button" value="+">
                                <span class="main__product-desc" style="margin-left: 10px;"><?php echo $row['SoLuongSP']; ?> sản phẩm có sẵn</span>
                                </div>
                                <div style="margin-top: 20px;">
                                    <button id="addToCartBtn" type="submit" class="btn-add btn text-uppercase">Thêm vào giỏ</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="main__product-info">
                    ...
                    <span class="span-block">Danh mục: <a href="SanPham.php"> Trang sức , </a><a href="SanPham.php?TH=<?= $row['ThuongHieu']; ?>"><?= $row['ThuongHieu'] ?>, </a><a href="SanPham.php?BM=<?= $row['ChatLieu']; ?>"><?= $row['ChatLieu']; ?></a></span>
                </div>
<?php
        }
    }
