     ...
     <div class="header">
        <div class="d_header-top">
            <div class="d_header-top-content ">
                <div class="d_header-top-left  ">
                   <a href="index.php"><img src="./image/123.png" style="height: 150px; padding-bottom: 55px;"></a>
                </div>
      ...
      <b style="display: flex;">
          <div class="d_cart d_text d_color-white-bold">
              <a href="giohang.php" style="display: flex;     color: white;">
          ...
          <!-- </div>
          <div class="d_cart d_text d_color-white-bold">
          <a href="TTDonHang.php" style="display: flex;     color: white;">
          <i class="fas fa-shopping-cart" style="font-size: 25px;"></i>
              <p class="d_cart_text">Đơn hàng: <?php echo getCountProducts(); ?></p>
          </a>
          </div> -->
      ...
      <div class="wpb_text_column wpb_content_element ">
        ...
        <div class="n_about_card">
          <div class="card card_about hic" id="card_about1" style="width: 18rem;">
            ...
            <div class="card-body">
              <p class="card-text">Được nghiên cứu và đem lại cho khách hàng nhiều mẫu đồng hồ chất lượng và tin cậy.</p>
            </div>
          </div>
      ...
      <footer class="py-2">
        ...
        <div class="container n_footer-flex">
          ...
          <div class="n_footer-logo">
              <img src="image/123.png" style="height: 75px">
          </div>
