        ...
        <div class="card-row">
            <div class="card__product shadow-lg bg-1" >
                ...
                <div class="card__right">
                    ...
                    <span style="display:block">Số lượng trang sức bán ra</span>
                </div>
            </div>
        ...
        <!-- <div class="card-row"> -->
            ...
            <div class="card__product shadow-lg bg-3">
                ...
                <div class="card__right">
                    ...
                    <?php echo number_format(floatval(mysqli_fetch_row(mysqli_query($con, "SELECT SUM(TongTien) FROM dathang WHERE trangthai = 'hoàn thành'"))[0])); ?>
                    </h2>
